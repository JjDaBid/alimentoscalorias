...
public class FrutasYVerdurasView extends javax.swing.JPanel {

    public FrutasYVerdurasView() {
        initComponents();
        loadFruitsAndVegetables();
    }
    
    private void loadFruitsAndVegetables(){
        FrutasYVerdurasController.tableModel(fruitsDataTable);
    }
    
    private void filterFruitsAndVegetables(){
        FrutasYVerdurasController.filterFruitOrVegetable(barraBusqueda.getText(), fruitsDataTable);
    }
    ...
    private void initComponents() {
        ...
        fruitsDataTable = new javax.swing.JTable();
        ...
        fruitsDataTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Id", "Nombre", "Tipo", "Naturaleza", "Proteína", "Carbohidrato", "Grasa", "Total Calorías"
            }
        ) {
        ...
        fruitsDataTable.setGridColor(new java.awt.Color(255, 255, 255));
        fruitsDataTable.setSelectionBackground(new java.awt.Color(49, 175, 180));
        jScrollPane1.setViewportView(fruitsDataTable);
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        if(fruitsDataTable.getSelectedRow() > -1){
            try{
                int idFruitOrVegetable = (int)fruitsDataTable.getValueAt(fruitsDataTable.getSelectedRow(), 0); 
                FrutasYVerdurasController.getFruitOrVegetableById(idFruitOrVegetable);               
                showJPanel(new FrutasYVerdurasDetail(FrutasYVerdurasController.getFruitOrVegetableById(idFruitOrVegetable)));
            } catch (Exception e){
            }
        } else {
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        showJPanel(new FrutasYVerdurasForm());
        ...
        if(fruitsDataTable.getSelectedRow() > -1){
            int option = JOptionPane.showConfirmDialog(this, "¿Está seguro de que desea Eliminar el Alimento?", "Confirmación", JOptionPane.YES_NO_OPTION);                
                if (option == JOptionPane.YES_OPTION) {
                    try{
                        int idFruitOrVegetable = (int)fruitsDataTable.getValueAt(fruitsDataTable.getSelectedRow(), 0); 
                        FrutasYVerduras fv = FrutasYVerdurasController.getFruitOrVegetableById(idFruitOrVegetable); 
                        FrutasYVerdurasController.deleteFruitOrVegetable(fv, fruitsDataTable);
...
//         filterFruitsAndVegetables();
    ...
    private javax.swing.JTable fruitsDataTable;
