package views.hidratosdecarbonoviews;


import Controller.HidratosDeCarbonoController;
...
public class HidratosDeCarbonoForm extends javax.swing.JPanel {
    
    boolean isEdition = false; 
    HidratosDeCarbono edicionHidratosDeCarbono;

    public HidratosDeCarbonoForm() {
        initComponents();
        initStyles();
        setListeners();        
    }
    
    public HidratosDeCarbonoForm(HidratosDeCarbono carbohidratos) {
        initComponents();
        isEdition = true;
        edicionHidratosDeCarbono = carbohidratos;
        initStyles();
        setListeners();   
    }
    ...
    private void initStyles(){
        ...
        if(isEdition){
            pageTitle.setText("Editar Hidratos de Carbono");
            btnInsert.setText("Actualizar");
            txtImagen.setVisible(true);
            
            if(edicionHidratosDeCarbono != null){
                txtImagen.setText("Edicion Alimento " + edicionHidratosDeCarbono.getNombreAlimento());
                cmbTipo.setSelectedItem(edicionHidratosDeCarbono.getTipo());
                cmbGluten.setSelectedItem(edicionHidratosDeCarbono.getTienenGluten());
                txtNombre.setText(edicionHidratosDeCarbono.getNombreAlimento());
                cmbClasification.setSelectedItem(edicionHidratosDeCarbono.getClasificacion());
                txtProteinas.setText(String.valueOf(edicionHidratosDeCarbono.getProteinas()));
                txtGrasa.setText(String.valueOf(edicionHidratosDeCarbono.getGrasa()));
                txtCarbohidratos.setText(String.valueOf(edicionHidratosDeCarbono.getCarbohidratos()));
                txtCalorias.setText(String.valueOf(edicionHidratosDeCarbono.getCalorias()));
            }
        }        
    }
    ...
    private void initComponents() {
        ...
        cmbGluten = new javax.swing.JComboBox<>();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/carbohidratosbanners.jpg"))); // NOI18N
        ...
        pageTitle.setText("Hidratos de Carbono");

        cmbTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Azúcar", "Almidón", "Fibra" }));
        ...
        cmbGluten.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Con Glúten", "Sin Glúten" }));
        cmbGluten.setSelectedIndex(-1);
        cmbGluten.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbGlutenActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(contentPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(cmbGluten, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, contentPanelLayout.createSequentialGroup()
                ...
                .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(contentPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(cmbGluten, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    String gluten = (String)cmbGluten.getSelectedItem();
    ...
    String calorias = txtCalorias.getText();
        ...
        if(tipo == null || gluten == null || nombre.isEmpty() || clasificacion == null || calorias.isEmpty() || proteinas.isEmpty() || grasa.isEmpty() || carbohidratos.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Debe llenar todos los campos. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
            txtNombre.requestFocus();
            return;
        } else {        
            if(HidratosDeCarbonoController.clasificationValidator(clasificacion, this)){
                HidratosDeCarbono hc = isEdition ? edicionHidratosDeCarbono : new HidratosDeCarbono();
                hc.setTipo(tipo);
                hc.setTienenGluten(gluten);
                hc.setNombreAlimento(nombre);
                hc.setClasificacion(clasificacion);
                hc.setProteinas(Double.parseDouble(proteinas));
                hc.setGrasa(Double.parseDouble(grasa));
                hc.setCarbohidratos(Double.parseDouble(carbohidratos));
                hc.setCalorias(Double.parseDouble(calorias));
                try {
                    if(!isEdition) {
                        HidratosDeCarbonoController.createCarb(
                            tipo,
                            gluten,
                            0,
                            nombre,
                        ...
                        HidratosDeCarbonoController.updateCarb(hc, this);
    ...
    private void cmbGlutenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbGlutenActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbGlutenActionPerformed

    private void cleanForm(){
        cmbTipo.setSelectedIndex(0);
        cmbGluten.setSelectedIndex(0);
        txtNombre.setText("");
        cmbClasification.setSelectedIndex(2);
        txtProteinas.setText("0.0");
        txtGrasa.setText("0.0");
        txtCarbohidratos.setText("0.0"); 
    ...
    private javax.swing.JComboBox<String> cmbGluten;
