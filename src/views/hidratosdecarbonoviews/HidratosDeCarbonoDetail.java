...
public class HidratosDeCarbonoDetail extends javax.swing.JPanel {
    HidratosDeCarbono carbohidratos;
 
    public HidratosDeCarbonoDetail(HidratosDeCarbono carbs) {
        initComponents();
        carbohidratos = carbs;
        details();
    }
   ...
   private void details(){
       tipoLabel.setText(carbohidratos.getTipo());
       glutenLabel.setText(carbohidratos.getTienenGluten());
       nombreLabel.setText(carbohidratos.getNombreAlimento());
       clasificacionLabel.setText(carbohidratos.getClasificacion());
       proteinasLabel.setText(String.valueOf(carbohidratos.getProteinas()));
       grasasLabel.setText(String.valueOf(carbohidratos.getGrasa()));
       carbohidratosLabel.setText(String.valueOf(carbohidratos.getCarbohidratos()));
       caloriasLabel.setText(String.valueOf(carbohidratos.getCalorias()));
   }
   ...
   public void closePanel(JPanel panel){
    ...
    private void initComponents() {
        ...
        glutenLabel.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        glutenLabel.setText("jLabel11");
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        int idCarb = carbohidratos.getIdAlimentos();
