...
public class HidratosDeCarbonoView extends javax.swing.JPanel {

    public HidratosDeCarbonoView() {
        initComponents();
        loadHidratosDeCarbono();
    }
    
    private void loadHidratosDeCarbono(){
        HidratosDeCarbonoController.tableModel(carbsDataTable);
        
    }
    
    private void filterHidratosDeCarbono(){
        HidratosDeCarbonoController.filterCarbs(barraBusqueda.getText(), carbsDataTable);
    }
    ...
    private void initComponents() {
        ...
        carbsDataTable = new javax.swing.JTable();
        ...
        carbsDataTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Id", "Nombre", "Tipo", "Gúten", "Proteína", "Carbohidrato", "Grasa", "Total Calorías"
            }
        ) {
        ...
        carbsDataTable.setGridColor(new java.awt.Color(255, 255, 255));
        carbsDataTable.setSelectionBackground(new java.awt.Color(49, 175, 180));
        jScrollPane1.setViewportView(carbsDataTable);
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        if(carbsDataTable.getSelectedRow() > -1){
            try{
                int idCarb = (int)carbsDataTable.getValueAt(carbsDataTable.getSelectedRow(), 0); 
                HidratosDeCarbonoController.getCarbById(idCarb);               
                showJPanel(new HidratosDeCarbonoDetail(HidratosDeCarbonoController.getCarbById(idCarb)));
            } catch (Exception e){
            }
        } else {
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        showJPanel(new HidratosDeCarbonoForm());
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        if(carbsDataTable.getSelectedRow() > -1){
            try{
                int idCarb = (int)carbsDataTable.getValueAt(carbsDataTable.getSelectedRow(), 0); 
                HidratosDeCarbonoController.getCarbById(idCarb);               
                showJPanel(new HidratosDeCarbonoForm(HidratosDeCarbonoController.getCarbById(idCarb)));
            } catch (Exception e){
            }
        } else {
        ...
        if(carbsDataTable.getSelectedRow() > -1){
            int option = JOptionPane.showConfirmDialog(this, "¿Está seguro de que desea Eliminar el Alimento?", "Confirmación", JOptionPane.YES_NO_OPTION);                
                if (option == JOptionPane.YES_OPTION) {
                    try{
                        int idCarb = (int)carbsDataTable.getValueAt(carbsDataTable.getSelectedRow(), 0); 
                        HidratosDeCarbono hc = HidratosDeCarbonoController.getCarbById(idCarb); 
                        HidratosDeCarbonoController.deleteCarb(hc, carbsDataTable);
...
//         filterFruitsAndVegetables();
    ...
    private javax.swing.JTable carbsDataTable;
