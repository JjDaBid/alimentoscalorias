...
public class GrasasForm extends javax.swing.JPanel {
    
    boolean isEdition = false;
    Grasas edicionGrasas;
    ...
    public GrasasForm(Grasas grasas) {
        initComponents();
        isEdition = true;
        edicionGrasas = grasas;
        initStyles();
        setListeners();   
    }
    ...
    private void initStyles(){
        ...
        if(isEdition){
            pageTitle.setText("Editar Grasas");
            btnInsert.setText("Actualizar");
            txtImagen.setVisible(true);
            
            if(edicionGrasas != null){
                txtImagen.setText("Edicion Alimento " + edicionGrasas.getNombreAlimento());
                cmbOrigen.setSelectedItem(edicionGrasas.getOrigen());
                txtNombre.setText(edicionGrasas.getNombreAlimento());
                cmbClasification.setSelectedItem(edicionGrasas.getClasificacion());
                txtProteinas.setText(String.valueOf(edicionGrasas.getProteinas()));
                txtGrasa.setText(String.valueOf(edicionGrasas.getGrasa()));
                txtCarbohidratos.setText(String.valueOf(edicionGrasas.getCarbohidratos()));
                txtCalorias.setText(String.valueOf(edicionGrasas.getCalorias()));
            }
        }        
    }
    ...
    private void setImage(){
        String selection = cmbOrigen.getSelectedItem().toString();
    ...
    private void initComponents() {
        ...
        cmbOrigen.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Animal", "Vegetal" }));
                            ...
                            .addGroup(contentPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(contentPanelLayout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(cmbOrigen, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        if(origen == null || nombre.isEmpty() || clasificacion == null || calorias.isEmpty() || proteinas.isEmpty() || grasa.isEmpty() || carbohidratos.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Debe llenar todos los campos. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
            txtNombre.requestFocus();
            return;
        } else {
            
            if(GrasasController.grasaClasificationValidator(clasificacion, this)){
                Grasas grasaObj = isEdition ? edicionGrasas : new Grasas();
                grasaObj.setOrigen(origen);        
                grasaObj.setNombreAlimento(nombre);
                grasaObj.setClasificacion(clasificacion);
                grasaObj.setProteinas(Double.parseDouble(proteinas));
                grasaObj.setGrasa(Double.parseDouble(grasa));
                grasaObj.setCarbohidratos(Double.parseDouble(carbohidratos));
                grasaObj.setCalorias(Double.parseDouble(calorias));

                try {
                    if(!isEdition) {
                        GrasasController.createGrasa(
                            origen,                
                            0,
                            nombre,
                            clasificacion,
                        ...
                        GrasasController.updateGrasa(grasaObj, this);
                        System.out.println("1. AccionAcutalizar desde formulario");
