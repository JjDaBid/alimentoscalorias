...
import views.frutasyverdurasviews.*;
...
public class GrasasDetail extends javax.swing.JPanel {
    Grasas grasa;
 
    public GrasasDetail(Grasas fat) {
        initComponents();
        grasa = fat;
        details();
    }
   ...
   private void details(){
       origenLabel.setText(grasa.getOrigen());       
       nombreLabel.setText(grasa.getNombreAlimento());
       clasificacionLabel.setText(grasa.getClasificacion());
       proteinasLabel.setText(String.valueOf(grasa.getProteinas()));
       grasasLabel.setText(String.valueOf(grasa.getGrasa()));
       carbohidratosLabel.setText(String.valueOf(grasa.getCarbohidratos()));
       caloriasLabel.setText(String.valueOf(grasa.getCalorias()));
   }
   ...
   public void closePanel(JPanel panel){
    ...
    private void initComponents() {
        ...
        origenLabel.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        origenLabel.setText("jLabel10");
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        int idfat = grasa.getIdAlimentos();
